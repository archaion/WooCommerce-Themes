...
<body <?php body_class(); ?>>
   ...
   <div id="page" class="site">
      ...
      <?php if (is_shop() || is_archive() || is_search()) : ?>
         <header id="vidwrap">
            <video id="vid" autoplay muted loop playsinline autobuffer poster="https://PLACEHOLDER.COM/wp-content/themes/NEW/vidback.jpg">
               <source src="https://PLACEHOLDER.COM/wp-content/themes/NEW/Slideshow.mp4" type="video/mp4">
            </video>
         </header>
      <?php endif; ?>
      <header id="masthead" class="site-header">
         ...
         <nav id="site-navigation" class="main-navigation">
            ...
            <section id="searchbar" class="widget widget_block widget_search">
               <form role="search" method="get" action="https://***YOUR URL HERE***.co/" class="wp-block-search__button-outside wp-block-search__text-button wp-block-search">
                  ...
                  <div class="wp-block-search__inside-wrapper " style="width: 777px">
                     ...
                     <?php else : ?>
                        <a id="filters" href="<?php echo esc_url('https://***YOUR URL HERE***.co/shop#secondary'); ?>">Filters</a>
                     <?php endif; ?>
                  </div>
               </form>
            </section>
